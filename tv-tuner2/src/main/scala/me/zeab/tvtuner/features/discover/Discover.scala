package me.zeab.tvtuner.features.discover

import akka.http.scaladsl.model._
import akka.http.scaladsl.server.{Directives, Route}
import io.circe.generic.auto._
import io.circe.syntax.EncoderOps
import me.zeab.tvtuner.features.discover.models.Device
import me.zeab.tvtuner.service.AppConf.exposedAddress
...
trait Discover extends Directives {
  ...
  val deviceXml: Route =
    path("device.xml") {
      get {
        val inetAddress: String = s"http://$exposedAddress"
